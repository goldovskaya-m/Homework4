public class Main {
    public static void main(String[] args) {
...

        {
            ...
            int temperature = 5;
            if (temperature < 5) {
                System.out.println("На улице ниже 5 градусов, " +
                        "нужно надеть шапку.");
            } else {

                System.out.println("На улице выше 5 градусов, " +
            ...
            if (children >= 5 && children < 14) {
                System.out.println(" Если ребёнку " + children + " лет, но меньше 14 " +
                        " ,то он может кататься только в сопровождении" +
                        " взрослого. Если взрослого нет, то кататься нельзя.");
            }
            if (children >= 14) {
                System.out.println("Если ребёнку " + children + " ,то " +
